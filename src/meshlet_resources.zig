...
pub const MeshletResources = struct {
    ...
    pub fn init(geometry: *const Geometry, dx12: *const Dx12State) MeshletResources {
        ...
        const vertex_srv_desc = d3d12.SHADER_RESOURCE_VIEW_DESC.initStructuredBuffer(0, geometry.total_vertex_count, @sizeOf(mesh_data.Vertex));
        ...
        const index_srv_desc = d3d12.SHADER_RESOURCE_VIEW_DESC.initTypedBuffer(.R32_UINT, 0, geometry.total_index_count);
        ...
        const meshlet_srv_desc = d3d12.SHADER_RESOURCE_VIEW_DESC.initStructuredBuffer(0, geometry.total_meshlet_count, @sizeOf(mesh_data.Meshlet));
        ...
        const meshlet_data_srv_desc = d3d12.SHADER_RESOURCE_VIEW_DESC.initTypedBuffer(.R32_UINT, 0, geometry.total_meshlet_data_count);
